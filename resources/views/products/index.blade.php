...
@section('content')
    <!-- Page Header -->
 <section class="w-full bg-gray-50 py-8 bg-cover bg-center min-h-[500px]" style="background-image: url('{{ asset('storage/' . $category->featured) }}'); background-position:cover; background-repeat:no-repeat; min-height:400px !important; ">
     {{--  --}}
