    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="space-y-6" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Images Section -->
                <div class="space-y-6">
                    <h3 class="text-lg font-medium text-gray-900">Category Images</h3>
                ...
                <div class="space-y-6">
                    ...
                    <!-- Current Images -->
                        ...
                        <div class="space-y-4">
                            <h4 class="text-md font-medium text-gray-700">Current Featured Banner</h4>
                        ...
                        <!-- New Main Image -->
                        <div class="space-y-3">
                            <label class="block text-sm font-medium text-gray-700">New Featured Image</label>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <!-- Upload Info -->
                                <div class="flex-1">
                                    <input type="file" id="image" name="featured" accept="image/*">
                                    <div class="space-y-2">
