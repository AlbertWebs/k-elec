    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('admin.banners.update', $banner) }}" method="POST" class="space-y-6" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                   <div>
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-1">banner Position *</label>
                        <input type="text" id="name" name="position" required 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Images Section -->
                <div class="space-y-6">
                    {{-- <h3 class="text-lg font-medium text-gray-900">banner Images</h3> --}}
