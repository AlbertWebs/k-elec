...
<!-- Main Header -->
<header class="bg-red-600 text-white shadow-sm w-full">
    <div class="w-full px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between py-2 max-w-7xl mx-auto">
            <!-- Logo -->
            <div class="flex-shrink-0">
                <a href="{{ route('home') }}">
                    <img style="width:80px; height:auto; object-fit:cover;" src="{{ asset('images/logo-white.png') }}" alt="K-ELEC" class="h-12 brand-logo">
                </a>
            </div>
            ...
            <!-- Company Info Center -->
            <div class="flex-1 max-w-4xl mx-8 hidden md:flex items-center justify-center">
                <div class="flex flex-wrap items-center justify-center gap-6 text-center text-white text-sm font-medium">
                    <span class="whitespace-nowrap">KOREAN TECH, KENYANTRUST</span>
                    <span class="text-gray-200"><br></span>
                    <a href="tel:+254716052243" class="hover:text-gray-200 whitespace-nowrap">+254716052243</a>
                    <span class="text-gray-200"><br></span>
                    <a href="mailto:k.eleckenya@gmail.com" class="hover:text-gray-200 truncate">k.eleckenya@gmail.com</a>
            ...
            <div class="flex items-center space-x-6">
                <!-- Desktop Elements -->
                <button style="background-color: #0b384e; color: white; padding: 0.375rem 1.5rem; border-radius: 0.5rem; font-weight: 600; border: none; cursor: pointer; font-size: 0.875rem;" class="hidden md:block">
                    BE A VENDOR
                </button>
                ...
                <button id="mobile-search-button" class="md:hidden flex items-center space-x-2 text-white hover:text-gray-800">
   ...
   <!-- Navigation Menu -->
    <nav class="bg-white hidden md:block mx-auto w-full pt-4 pb-4">
        <div class="px-4 sm:px-6 lg:px-8 w-full">
            <div class="flex bg-gray-100 items-center w-full mx-auto" style="max-width:none;">
                ...
                class="ml-4 font-semibold px-5 py-3 flex items-center space-x-2 
