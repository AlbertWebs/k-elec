...
<h2 class="mt-4 mb-8 text-2xl lg:text-3xl font-bold text-black-900 text-center">ABOUT K-ELEC</h2>
    ...
    <div class="flex flex-col gap-8">
      ...
      <div class="flex justify-center">
        <div class="w-full max-w-6xl" style="height: 600px;">
            ...
            <iframe 
              src="https://drive.google.com/file/d/1goNHL_j4Rt-IMOn59-_CQLVSPMOUk9hZ/preview" 
            ...
            <!-- Fallback Image -->
            <!-- <img src="https://i.postimg.cc/d35wdqmX/kelec-fridge.png" 
                 alt="About K-Elec" 
