...
@section('title', 'Create Brand Shop')

@section('content')
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Create Brand Shop</h1>
            <p class="text-gray-600">Add a new brand shop location</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('admin.brand-shops.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" required 
                           ...
                           value="{{ old('name') }}" placeholder="e.g., K-Elec Westlands">
                    @error('name')
                ...
                <div>
                    ...
                    <input type="text" id="area" name="area" required 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                           value="{{ old('area') }}" placeholder="e.g., Westlands">
                    @error('area')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="tel" id="phone" name="phone" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                           value="{{ old('phone') }}" placeholder="+254 700 123 456">
                    @error('phone')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="url" id="directions_url" name="directions_url" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500"
                           value="{{ old('directions_url') }}" placeholder="https://maps.google.com/...">
                ...
                <div class="space-y-3 bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" name="timing_{{ $day }}" 
                               ...
                               placeholder="e.g., 9AM-6PM" value="{{ old("timing_$day") }}">
                    </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="flex items-center">
                <input type="checkbox" id="is_active" name="is_active" value="1" class="rounded border-gray-300 text-red-600" {{ old('is_active') ? 'checked' : '' }}>
